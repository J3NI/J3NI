...
GetSoLConfigCMD::GetSoLConfigCMD(): parameterRevision(0x00), setInProgress(0x00), SoLEnable(0x01), SoLAuth(0x00), charAccumulateIntervals(0x05), charSendThresh(0x64), SoLRetryCount(0x03), SoLRetryInterval(0xFA), SoLBitRate_NV(0x07), SoLBitRate_V(0x07), SoLChannel(0x00), SoLPort(0x00) { }
...
unsigned char GetSoLConfigCMD::getSoLPort()
{
     return SoLPort;
}
...
void GetSoLConfigCMD::setSoLPort(unsigned char port)
{
    SoLPort = port;
}
